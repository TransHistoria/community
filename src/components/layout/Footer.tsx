    ...
    <footer className="hidden md:block border-t border-border bg-bg-warm/60">
      <div className="container py-10 grid gap-8 md:grid-cols-3">
        ...
        <nav className="grid grid-cols-2 gap-2 text-sm text-ink-muted">
          ...
          <Link href={toQueryRoute("/about#community-guidelines")} className="hover:text-ink">社区守则</Link>
          <Link href={toQueryRoute("/about#privacy")} className="hover:text-ink">隐私承诺</Link>
          <Link href={toQueryRoute("/about#safety")} className="hover:text-ink">安全提示</Link>
        </nav>
